...
const stats = [
  {
    value: "10K+",
    label: "Schemas managed",
  },
  {
    value: "50K+",
    label: "Migrations deployed",
  },
  {
    value: "99.9%",
    label: "Uptime SLA",
      ...
      <div className="container flex max-w-5xl flex-col justify-between gap-8 md:gap-20 lg:flex-row lg:items-center lg:gap-24 xl:gap-24">
        <div className="flex-[1.5]">
          <h1 className="text-3xl tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
            Democratising database schema management
          </h1>
          ...
          <p className="text-muted-foreground mt-8 max-w-lg space-y-6 text-base text-balance lg:text-lg lg:mt-12">
            ...
            migration failures, and deployment anxiety through actionable
            insights and seamless collaboration. We&apos;ll stop at nothing to
            ...
            because when your schemas succeed, so do we.
          </p>
        </div>
