...
const topItems = [
  {
    ...
    description:
      "Create reusable migration templates for common schema changes like adding columns, creating indexes, or altering constraints.",
    images: [
      {
        src: "/resource-allocation/templates.webp",
        alt: "Migration template interface",
        width: 495,
        height: 186,
      },
    ],
  ...
  },
  {
    ...
    description: "No more ad-hoc SQL scripts, shared documents, or manual tracking.",
    images: [
...
const bottomItems = [
  {
    ...
    description:
      "Track deprecated schemas and migration history for auditing and compliance purposes.",
    images: [
      {
        src: "/resource-allocation/graveyard.webp",
        alt: "Deprecated schemas interface",
        width: 305,
        height: 280,
      },
    ],
  ...
  },
  {
    ...
    description:
      "Collaborate on schema reviews with inline comments and approvals before deploying to production.",
    images: [
      {
        src: "/resource-allocation/discussions.webp",
        alt: "Schema review discussions interface",
        width: 320,
        height: 103,
      },
    ],
  ...
  },
  {
    title: "Drift alerts.",
    description:
      "Get notified when schema drift is detected or migrations fail in any environment.",
    images: [
      {
        src: "/resource-allocation/notifications.webp",
        alt: "Drift alert notifications interface",
        width: 305,
        height: 280,
      },
    ],
    ...
    >
      <div className="">
        <h2 className="container text-center text-3xl tracking-tight text-balance sm:text-4xl md:text-5xl lg:text-6xl">
          Mainline your schema versioning and deployment workflow
        </h2>
